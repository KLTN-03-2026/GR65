...
import {
  Brain, Target, Eye, Mail, Phone, MapPin, Briefcase, Star,
  Search, Filter, Download, ChevronDown, User, Zap, Clock,
  CheckCircle, XCircle, MessageSquare, Calendar, FileText
} from "lucide-react";
...
export function CandidateList() {
  ...
  const getCandidateApplications = (id: string) => mockApplications.filter(a => a.candidateId === id);
