        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-50 bg-gray-50">
              {["Tên / Email", "Vai trò", "Đăng nhập", "Ngày tham gia", "Trạng thái", "Hành động"].map((h) =>
                ...
                <tr key={u.Id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-4 py-4">
                    {u.AuthProvider === 'google' ? (
                      <span className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-lg bg-blue-50 text-blue-600 border border-blue-100 w-fit">
                      ...
                      <span className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-lg bg-gray-50 text-gray-500 border border-gray-100 w-fit">
