...
import {
  Brain, Shield, Users, BarChart3, FileSearch,
...
export function LandingPage() {
  ...
  const faqs = [
    ...
    { q: "Có thể dùng thử miễn phí không?", a: "Có! Bạn có thể đăng ký dùng thử miễn phí 14 ngày với đầy đủ tính năng, không cần thông tin thẻ tín dụng." },
