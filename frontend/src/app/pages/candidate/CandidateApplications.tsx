...
import {
  ...
  Brain, ArrowRight, Filter, MessageSquare, Bell, FileText
} from "lucide-react";
...
export function CandidateApplications() {
  ...
  const countByStage = (key: string) => key === "all" ? myApplications.length : myApplications.filter(a => a.status === key).length;
