...
import {
  ...
  Mail, Calendar,
  Eye, ChevronDown, Crown, Plus } from
"lucide-react";
...
export function AccountManagement() {
  ...
  const handleToggleCandidateStatus = (id, name) => {
  ...
  const handleToggleEmployerStatus = (id, name) => {
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-50">
                ...
                const sb = statusBadge(status);
                const planColors = { Basic: "bg-gray-100 text-gray-600", Pro: "bg-indigo-100 text-indigo-600", Enterprise: "bg-violet-100 text-violet-600" };
                return (
