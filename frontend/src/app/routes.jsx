...
export const router = createBrowserRouter([
  ...
  {
    path: "/candidate",
    element: <ProtectedRoute allowedRoles="Candidate"><CandidateLayout /></ProtectedRoute>,
    children: [
  ...
  {
    path: "/employer",
    element: <ProtectedRoute allowedRoles="Employer"><EmployerLayout /></ProtectedRoute>,
    children: [
