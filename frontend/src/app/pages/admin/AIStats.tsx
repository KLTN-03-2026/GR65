import {
  Brain, TrendingUp, FileText, Image, File, Zap, CheckCircle,
  Target, BarChart3, RefreshCw, ArrowUpRight, Activity, Cpu
} from "lucide-react";
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
          ...
          <div className="space-y-3">
            {cvFormats.map(fmt => {
              const Icon = (formatIcons as any)[fmt.format] || FileText;
              return (
